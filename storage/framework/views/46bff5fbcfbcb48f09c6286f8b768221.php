...
<div class="p-6 bg-white rounded-2xl shadow">
    ...
    <div class="flex justify-end items-center mb-4">
        <a href="<?php echo e(route('alternatif.create')); ?>" 
    ...
    <div class="overflow-x-auto">
        <table class="w-full border border-green-200 rounded-lg text-sm">
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $alternatif; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $a): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr class="hover:bg-green-50 transition">
                    <td class="p-3 border-b"><?php echo e($a->code); ?></td>
                    <td class="p-3 border-b font-semibold text-green-700"><?php echo e($a->nama); ?></td>
                    <td class="p-3 border-b text-gray-700"><?php echo e($a->deskripsi ?? '-'); ?></td>
                    <td class="p-3 border-b text-center"><?php echo e($a->tahun ?? '-'); ?></td>
                    <td class="p-3 border-b text-center">
                        <div class="flex justify-center gap-2">
                            <a href="<?php echo e(route('alternatif.edit', $a->id)); ?>" 
                            ...
                            <button type="button"
                                    ...
                                    data-id="<?php echo e($a->id); ?>" data-nama="<?php echo e($a->nama); ?>">
        ...
        btn.addEventListener('click', function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    form.method = 'POST';
                    form.action = `<?php echo e(url('admin/alternatif')); ?>/${id}`;
...
<?php echo $__env->make('admin.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\spk-palawija-271025\spk-palawija\resources\views/admin/alternatif/index.blade.php ENDPATH**/ ?>