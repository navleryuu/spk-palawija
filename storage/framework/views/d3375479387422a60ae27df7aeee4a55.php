...
<body class="bg-green-50 text-gray-800 font-sans">
    ...
    <div class="min-h-screen flex flex-col justify-between">
        ...
        <header class="flex items-center gap-3 px-10 lg:px-28 pt-8">
            <img src="<?php echo e(asset('images/logo-dinas.png')); ?>" alt="Logo Dinas Pertanian" class="w-10 h-10">
        ...
        <main class="flex flex-col lg:flex-row items-center justify-between px-10 lg:px-28 flex-1">
            ...
            <div class="max-w-xl text-center lg:text-left space-y-6">
                ...
                <div class="flex justify-center lg:justify-start gap-4">
                    ...
                    <a href="<?php echo e(route('login')); ?>?role=admin"
                    ...
                    <a href="<?php echo e(route('login')); ?>?role=kepala_dinas"
            ...
            <div class="mt-12 lg:mt-0">
                <img src="<?php echo e(asset('images/logo-orang.png')); ?>" alt="Petani Ilustrasi" class="w-[700px] mx-auto drop-shadow-xl">
            </div>
        </main>
...
<?php /**PATH D:\spk-palawija-271025\spk-palawija\resources\views/home.blade.php ENDPATH**/ ?>