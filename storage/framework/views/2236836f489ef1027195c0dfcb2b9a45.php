    ...
    <div class="min-h-screen flex items-center justify-center">
        <div class="flex flex-col md:flex-row bg-white shadow-2xl rounded-3xl overflow-hidden w-full max-w-6xl">
            ...
            <div class="bg-green-200 flex flex-col justify-center items-center md:w-1/2 p-14 text-center">
                ...
                <img src="<?php echo e(asset('images/logo-orang.png')); ?>" alt="Ilustrasi Petani" 
            ...
            <div class="md:w-1/2 p-14 flex flex-col justify-center">
                <h2 class="text-3xl font-bold text-green-800 text-center mb-10 tracking-wide">
                    LOGIN <?php echo e(strtoupper(str_replace('_', ' ', $role))); ?>
                ...
                <form method="POST" action="<?php echo e(route('login.post')); ?>" class="space-y-6">
                    ...
                    <div class="text-right -mt-4">
                        <a href="<?php echo e(route('forgot.password')); ?>" class="text-sm text-green-700 hover:underline">
                            Lupa Password?
                        </a>
                    </div>
...
<?php /**PATH D:\spk-palawija-271025\spk-palawija\resources\views/auth/login.blade.php ENDPATH**/ ?>